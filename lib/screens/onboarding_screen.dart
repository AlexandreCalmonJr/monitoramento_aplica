// File: lib/screens/onboarding_screen.dart (CORRIGIDO)
...
class _OnboardingStep1 extends StatelessWidget {
  ...
  @override
  Widget build(BuildContext context) {
    // ✅ USA 'watch' para reconstruir quando 'forceLegacyMode' mudar
    ...
    return SingleChildScrollView(
      ...
      child: Column(
        ...
        children: [
          ...
          // ✅ --- CHECKBOX DE MODO LEGADO ADICIONADO DE VOLTA ---
          const SizedBox(height: 24),
          CheckboxListTile(
            title: const Text("Forçar Modo Legado (somente Desktop/Totem)"),
            subtitle: const Text(
            ...
            tileColor: Colors.grey[800]?.withOpacity(0.3),
            shape:
      ...
      child: Column(
        ...
        children: [
          _buildSectionHeader(
            ...
            subtitle: subtitle, // Subtítulo dinâmico
          ),
          const SizedBox(height: 24),
          ...
          _buildSectionHeader(
            ...
            subtitle: 'Opcional: Nome do ativo e localização física',
            isSubheader: true,
          ),
          const SizedBox(height: 16),
          ...
          Row(
            children: [
              TextButton(
                // ✅ CORREÇÃO: Volta para Etapa 2 (Módulos) ou 1 (Legado)
                onPressed: () {
